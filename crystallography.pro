...
function equivalent, hkl1, hkl2, exti
res = 0
case exti of
'CUBIC':$
begin
 if  ((abs(hkl1[0]) eq abs(hkl2[0])) and (abs(hkl1[1]) eq abs(hkl2[1])) and (abs(hkl1[2]) eq abs(hkl2[2]))) or $
     ((abs(hkl1[0]) eq abs(hkl2[0])) and (abs(hkl1[1]) eq abs(hkl2[2])) and (abs(hkl1[2]) eq abs(hkl2[1]))) or $
     ((abs(hkl1[0]) eq abs(hkl2[1])) and (abs(hkl1[1]) eq abs(hkl2[0])) and (abs(hkl1[2]) eq abs(hkl2[2]))) or $
     ((abs(hkl1[0]) eq abs(hkl2[1])) and (abs(hkl1[1]) eq abs(hkl2[2])) and (abs(hkl1[2]) eq abs(hkl2[0]))) or $
     ((abs(hkl1[0]) eq abs(hkl2[2])) and (abs(hkl1[1]) eq abs(hkl2[1])) and (abs(hkl1[2]) eq abs(hkl2[0]))) or $
     ((abs(hkl1[0]) eq abs(hkl2[2])) and (abs(hkl1[1]) eq abs(hkl2[0])) and (abs(hkl1[2]) eq abs(hkl2[1]))) or $
     ((hkl1[0] eq -hkl2[0]) and (hkl1[1] eq -hkl2[1]) and (hkl1[2] eq -hkl2[2])) then res=1

end
'HEXAGONAL':$
begin
 if  ((abs(hkl1[2]) eq abs(hkl2[2])) and (hkl1[1] eq hkl2[1]) and (hkl1[0] eq hkl2[0])) or   $
           ((hkl1[0] eq -hkl2[1]) and (hkl1[1] eq hkl2[0]-hkl2[1]) and (hkl1[2] eq hkl2[2])) or $
     ((hkl1[0] eq -hkl2[0]+hkl2[1]) and (hkl1[1] eq -hkl2[0]) and (hkl1[2] eq hkl2[2])) or $
     ((hkl1[0] eq -hkl2[0]) and (hkl1[1] eq -hkl2[1]) and (hkl1[2] eq -hkl2[2])) then res=1
end
'TETRAGONAL':$
begin
...
'MONOCLINIC':$
begin
 if  ((hkl1[0] eq hkl2[0]) and (abs(hkl1[1]) eq abs(hkl2[1])) and (hkl1[2] eq hkl2[2])) or $
      ((hkl1[0] eq -hkl2[0]) and (hkl1[1] eq -hkl2[1]) and (hkl1[2] eq -hkl2[2])) then res=1

end
'TRICLINIC':$
begin
   if ((hkl1[0] eq -hkl2[0]) and (hkl1[1] eq -hkl2[1]) and (hkl1[2] eq -hkl2[2])) then res=1
end
else: $
   if ((hkl1[0] eq -hkl2[0]) and (hkl1[1] eq -hkl2[1]) and (hkl1[2] eq -hkl2[2])) then res=1
endcase
