...
; Generated on:	08/31/2007 08:09.15
VERSION 1
END

WID_fit2d_shell BASE 0 5 1003 821
TLB
...
BEGIN
  ...
  END
 WID_TAB_10 TAB 0 0 788 780
 BEGIN
 WID_BASE_51 BASE 0 0 786 760
 CAPTION "Spectrum"
 BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      HEIGHT = 1
      END
      WID_BUTTON_71 PUSHBUTTON 211 165 92 29
      VALUE "Truncate"
      ALIGNCENTER
      END
    END
    ...
    BEGIN
      ...
      HEIGHT = 1
      END
      WID_BUTTON_51 PUSHBUTTON 25 77 94 37
      VALUE "Fit"
      ALIGNCENTER
      END
      WID_BUTTON_52 PUSHBUTTON 25 115 94 37
      VALUE "Subtract"
      ALIGNCENTER
      END
      WID_BUTTON_70 PUSHBUTTON 25 153 94 37
      VALUE "Save"
      ALIGNCENTER
      END
      ...
      HEIGHT = 2
      END
      WID_BUTTON_41 PUSHBUTTON 207 95 23 22
      VALUE "X"
      ALIGNCENTER
      END
