...
COMMON WID_fit2d_shell_elements, $
  ...
  WID_fit2d_shell = Widget_Base( GROUP_LEADER=wGroup,  $
      UNAME='WID_fit2d_shell' ,YOFFSET=5 ,SCR_XSIZE=1003  $
      ,SCR_YSIZE=801 ,TITLE='GSE_shell   ver 1.01' ,SPACE=3 ,XPAD=3  $
      ,YPAD=3)


  WID_BUTTON_1 = Widget_Button(WID_fit2d_shell, UNAME='WID_BUTTON_1'  $
      ,XOFFSET=795 ,YOFFSET=730 ,SCR_XSIZE=193 ,SCR_YSIZE=28  $
      ,/ALIGN_CENTER ,VALUE='Close')


  WID_DRAW_2 = Widget_Draw(WID_fit2d_shell, UNAME='WID_DRAW_2'  $
      ,XOFFSET=423 ,YOFFSET=39 ,SCR_XSIZE=364 ,SCR_YSIZE=269)


  WID_LIST_10 = Widget_List(WID_fit2d_shell, UNAME='WID_LIST_10'  $
      ,XOFFSET=793 ,YOFFSET=326 ,SCR_XSIZE=194 ,SCR_YSIZE=189  $
      ,XSIZE=11 ,YSIZE=2)
  ...
  WID_DRAW_0 = Widget_Draw(WID_fit2d_shell, UNAME='WID_DRAW_0'  $
  ...
  WID_TAB_0 = Widget_Tab(WID_fit2d_shell, UNAME='WID_TAB_0'  $
  ...
  WID_TAB_2 = Widget_Tab(WID_BASE_1, UNAME='WID_TAB_2' ,XOFFSET=1  $
      ,YOFFSET=2 ,SCR_XSIZE=330 ,SCR_YSIZE=243)


  WID_BASE_15 = Widget_Base(WID_TAB_2, UNAME='WID_BASE_15'  $
      ,SCR_XSIZE=322 ,SCR_YSIZE=217 ,TITLE='Integrate' ,SPACE=3  $
      ,XPAD=3 ,YPAD=3)


  WID_BASE_32 = Widget_Base(WID_BASE_15, UNAME='WID_BASE_32'  $
      ,SCR_XSIZE=601 ,SCR_YSIZE=462 ,TITLE='Integrate' ,SPACE=3  $
      ,XPAD=3 ,YPAD=3)


  WID_BUTTON_24 = Widget_Button(WID_BASE_32, UNAME='WID_BUTTON_24'  $
      ,XOFFSET=169 ,YOFFSET=11 ,SCR_XSIZE=66 ,SCR_YSIZE=35  $
      ,/ALIGN_CENTER ,VALUE='=>>')


  WID_BUTTON_26 = Widget_Button(WID_BASE_32, UNAME='WID_BUTTON_26'  $
  ...
  WID_BASE_20 = Widget_Base(WID_BASE_38, UNAME='WID_BASE_20'  $
      ,XOFFSET=100 ,YOFFSET=136 ,TITLE='IDL' ,COLUMN=1  $
      ,/NONEXCLUSIVE)
  ...
  WID_BUTTON_82 = Widget_Button(WID_BASE_38, UNAME='WID_BUTTON_82'  $
      ,XOFFSET=215 ,YOFFSET=71 ,SCR_XSIZE=19 ,SCR_YSIZE=22  $
      ,/ALIGN_CENTER ,VALUE='...')


  WID_LABEL_55 = Widget_Label(WID_BASE_38, UNAME='WID_LABEL_55'  $
      ,XOFFSET=4 ,YOFFSET=54 ,/ALIGN_LEFT ,VALUE='Image directory')


  WID_TEXT_38 = Widget_Text(WID_BASE_38, UNAME='WID_TEXT_38'  $
      ,XOFFSET=4 ,YOFFSET=73 ,SCR_XSIZE=202 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)
  ...
  WID_BUTTON_50 = Widget_Button(WID_BASE_4, UNAME='WID_BUTTON_50'  $
  ...
  WID_BASE_19 = Widget_Base(WID_BASE_4, UNAME='WID_BASE_19'  $
      ,XOFFSET=259 ,YOFFSET=151 ,TITLE='IDL' ,COLUMN=1  $
      ,/NONEXCLUSIVE)


  WID_BUTTON_89 = Widget_Button(WID_BASE_19, UNAME='WID_BUTTON_89'  $
      ,/ALIGN_LEFT ,VALUE='I scale')


  WID_BUTTON_88 = Widget_Button(WID_BASE_4, UNAME='WID_BUTTON_88'  $
      ,XOFFSET=18 ,YOFFSET=123 ,SCR_XSIZE=92 ,SCR_YSIZE=29  $
  ...
  WID_BASE_9 = Widget_Base(WID_BASE_3, UNAME='WID_BASE_9' ,XOFFSET=58  $
  ...
  WID_BASE_2 = Widget_Base(WID_BASE_3, UNAME='WID_BASE_2' ,XOFFSET=22  $
      ,YOFFSET=201 ,TITLE='IDL' ,COLUMN=1 ,/NONEXCLUSIVE)
  ...
  WID_BASE_8 = Widget_Base(WID_BASE_11, UNAME='WID_BASE_8'  $
      ,XOFFSET=24 ,YOFFSET=189 ,TITLE='IDL' ,COLUMN=1 ,/NONEXCLUSIVE)
