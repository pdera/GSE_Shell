...
; Generated on:	10/13/2007 08:24.32
VERSION 1
END
...
BEGIN
  ...
  BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          BEGIN
            ...
            END
          END
          WID_BUTTON_82 PUSHBUTTON 215 71 19 22
          VALUE "..."
          ALIGNCENTER
          END
          WID_LABEL_55 LABEL 4 54 0 0
          VALUE "Image directory"
          ALIGNLEFT
          END
          WID_TEXT_38 TEXT 4 72 202 21
          WIDTH = 20
          HEIGHT = 1
          END
    ...
    BEGIN
      ...
      HEIGHT = 1
      END
      WID_BASE_19 BASE 259 151 0 0
      COLUMNS = 1
      NONEXCLUSIVE
      CAPTION "IDL"
      BEGIN
        WID_BUTTON_89 PUSHBUTTON -1 -1 0 0
        VALUE "I scale"
        ALIGNLEFT
        END
      END
      WID_BUTTON_88 PUSHBUTTON 18 123 92 29
      VALUE "Print"
      ALIGNCENTER
      END
    END
  ...
  END
  END
    WID_BASE_22 BASE 0 0 780 736
    XPAD = 3
    YPAD = 3
    SPACE = 3
    CAPTION "WID_BASE_22"
    BEGIN
      WID_DRAW_1 DRAW 7 6 650 650
      END
    END
  END
  WID_BUTTON_1 PUSHBUTTON 795 730 193 28
  VALUE "Close"
  ALIGNCENTER
  END
